...
1. Theo *Từ điển từ cổ* (2001) của Vương Lộc:  
    *Khong* là từ vay mượn từ *"khoong"* của Tày, Nùng, nghĩa là "khen".

2. Theo *Việt Nam tự điển* (1970):  
    *Khong*, *khoen* là:

    - Vòng nhỏ kim loại để đeo tay.
...
2. X + không: chỉ có X chứ không có gì khác.

    Ví dụ:  
    a. Đi đám cưới mà đi tay *không* (mình *không*, mặt *không*): đến dự mà không cầm theo quà tặng gì.

    b. Lỗ *không*: chỉ có lỗ, ngoài ra không còn gì khác.

    c. Nguyễn Công Trứ:  
    "Đi *không*, há lẽ trở về *không*?  
    Cái nợ cầm thư phải trả xong.

    - Đi *không*: đi với tư thế người không có danh phận gì trong xã hội.
